						...
						<div class="col-md-12">
							<div class="input-group">
								<input type="text" class="form-control"
									placeholder="ISBN, Kitap Adı.." name="search" />
			...
			<div class="list-group">
				<c:forEach items="${books }" var="book">
					<li href="./book/${book.id}"
						...
						id="item_${book.id }"><a href="./book/${book.id}"
						...
						<p class="mb-1"></p> <small>${book.description }</small> <span
						class="pull-right"> <sec:authorize
							...
							</sec:authorize> <a type="button" href="book?id=${book.id }"
